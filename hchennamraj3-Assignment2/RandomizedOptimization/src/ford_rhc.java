...
public class ford_rhc {
    ...
    public static void main(String[] args) {
        ...
        int[] iterations = {10,100,500,1000,2500,5000, 10000, 15000, 20000, 25000};
        //int[] iterations = {10};
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int i = 0; i < oa.length; i++) {
                ...
                write_output_to_file("Optimization_Results", "ford_results_rhc.csv", final_result, true);
