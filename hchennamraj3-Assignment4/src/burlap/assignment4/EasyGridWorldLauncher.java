...
//			runner.runQLearning(gen,domain,initialState, rf, tf, env, showQLearningPolicyMap, 0.1, 0.99, 0.2, 0.99);
//			runner.runQLearning(gen,domain,initialState, rf, tf, env, showQLearningPolicyMap, 0.1, 0.99, 0.3, 0.99);
//			runner.runQLearning(gen,domain,initialState, rf, tf, env, showQLearningPolicyMap, 0.1, 0.99, 0.5, 0.99);
//			runner.runQLearning(gen,domain,initialState, rf, tf, env, showQLearningPolicyMap, 0.1, 0.99, 0.1, 0.99);
...
//			runner.runQLearning(gen,domain,initialState, rf, tf, env, showQLearningPolicyMap, 0.1, 0.99, 0.1, 0.1);
//			runner.runQLearning(gen,domain,initialState, rf, tf, env, showQLearningPolicyMap, 0.1, 0.99, 0.1, 0.5);
//			runner.runQLearning(gen,domain,initialState, rf, tf, env, showQLearningPolicyMap, 0.1, 0.99, 0.1, 0.99);
		}
